use cosmwasm_std::{
    coins, to_binary, BankMsg, Binary, CosmosMsg, Deps, DepsMut, Env, HandleResponse, InitResponse,
...
mod tests {
    ...
    use cosmwasm_std::{from_binary, Coin, HumanAddr, Storage, Uint128};
    ...
    fn query_get_works() {
        ...
        handle(deps.as_mut(), mock_env(), mock_info("anyone", &[]), msg).unwrap();
